...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('frontpages_article', ['category'])

        # Adding index on 'Article', fields ['newspaper_id']
        db.create_index('frontpages_article', ['newspaper_id'])

        # Adding index on 'Article', fields ['page_text']
        db.create_index('frontpages_article', ['page_text'])

        # Adding index on 'Article', fields ['article_date']
        db.create_index('frontpages_article', ['article_date'])


    def backwards(self, orm):
        # Removing index on 'Article', fields ['article_date']
        db.delete_index('frontpages_article', ['article_date'])

        # Removing index on 'Article', fields ['page_text']
        db.delete_index('frontpages_article', ['page_text'])

        # Removing index on 'Article', fields ['newspaper_id']
        db.delete_index('frontpages_article', ['newspaper_id'])

        # Removing index on 'Article', fields ['category']
        db.delete_index('frontpages_article', ['category'])
